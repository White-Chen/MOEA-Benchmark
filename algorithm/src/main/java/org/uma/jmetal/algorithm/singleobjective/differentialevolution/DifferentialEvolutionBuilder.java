...
public class DifferentialEvolutionBuilder {
    ...
    public DifferentialEvolution build() {
        return new DifferentialEvolution(problem, maxEvaluations, populationSize, crossoverOperator,
                selectionOperator, evaluator, varInProcessPath, funInProcessPath);
    }
    ...
    public DifferentialEvolutionBuilder setFunInProcessPath(String funInProcessPath) {
    ...
    public DifferentialEvolutionBuilder setVarInProcessPath(String varInProcessPath) {
