...
public class OMOPSO extends AbstractParticleSwarmOptimization<DoubleSolution, List<DoubleSolution>> {
    ...
    private static final long serialVersionUID = 8832198187695865380L;
    ...
    public OMOPSO(DoubleProblem problem, SolutionListEvaluator<DoubleSolution> evaluator,
                  ...
                  NonUniformMutation nonUniformMutation, String inProcessDataPath) {
    ...
    protected void saveDataInProcess() {
        if (!inProcessDataPath.isEmpty() && ((currentIteration % 7 == 0) || currentIteration == 2)) {
            new SolutionListOutput(getResult())
                    .setSeparator("\t")
                    .setVarFileOutputContext(new DefaultFileOutputContext(inProcessDataPath + "/VAR" + currentIteration + ".tsv"))
                    .setFunFileOutputContext(new DefaultFileOutputContext(inProcessDataPath + "/FUN" + currentIteration + ".tsv"))
                    .print();
        }
    }
}
