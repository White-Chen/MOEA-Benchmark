...
public class MOEADASStudy {
    private static final int INDEPENDENT_RUNS =2;   //每个算法跑20次实验m
        ...
        */
        ...
        List<Problem<DoubleSolution>> problemList = Arrays.<Problem<DoubleSolution>>asList(
             ...
             //   new DTLZ7()
                ...
                new UF1(),new UF2(),new UF3(), new UF4("Real",30),new UF5(30, 10, 0.1)
                //,new UF6(30, 2, 0.1),new UF7(),new UF8(30)
                //new UF9(30, 0.1),
              //  new UF10(30)
        ...
        List<String> referenceFrontFileNames = Arrays.asList(
              ...
              //  "ZDT3.pf", "ZDT4.pf", "ZDT6.pf"
               ...
               // "DTLZ3.3D.pf","DTLZ4.3D.pf","DTLZ7.3D.pf"
                 ...
                 "UF1.pf","UF2.pf","UF3.pf","UF4.pf","UF5.pf"
                //,"UF6.pf","UF7.pf","UF8.pf",
               // "UF9.pf", "UF10.pf"
