 ...
 * second front. No assumption is made about the second fhe supposed Pareto front.
 * It is a responsibility of the caller to ensure that this does not ront is a true Pareto front, i.e,
 * the front could contain solutions that dominate some of those of thappen.
 *
...
public class ErrorRatio<Evaluate extends List<? extends Solution<?>>>
    ...
    private static final long serialVersionUID = -8734823669380252986L;
